 ...
 */
export default function AccountSummary({ account, color = "blue" }) {
  ...
  return (
    <div
      className={`bg-white h-40 w-64 shadow-lg rounded-xl relative border-l-2 border-${color}-500 hover:bg-${color}-100 cursor-pointer dark:bg-gray-700 dark:text-white`}
    >
      <span
